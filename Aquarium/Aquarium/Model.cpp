...
//
//        //turn str to string
//        std::string string = std::string(str.C_Str());
//
...
//        {
//            if (textures_loaded[j].GetTexturePath() == string)
//            {
...
//            Texture texture;
//            texture.CreateTexture(string, 1.0f); // Alpha set to 1.0, change as needed
//            texture.SetTextureType(typeName);
//            texture.SetTexturePath(string);
...
//
//
//    string filename = dir + '\\' + string(path);
...
//    unsigned char* data = stbi_load(filenameCStr, &width, &height, &nrComponents, 0);
//    if (data)
//    {
//        GLenum format;
//        if (nrComponents == 1)
